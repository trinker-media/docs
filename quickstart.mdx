...
<Card title="Developer tools" icon="code" href="/developers/overview">
  Use the Public API, CLI, and MCP server to connect agents and automations to a Genseo project.
</Card>
